...
function PersonalHome() {
  ...
  const commands = [
    ...
    { cmd: '/profile', desc: 'Edit your profile' },
  ...
  const contentLines = [
    ...
    '',
    `Welcome back, ${userProfile?.username || user?.email?.split('@')[0] || 'researcher'}`,
    '',
            ...
            >
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  <div
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.borderColor = tokens.color.field.lilac;
                      e.currentTarget.style.opacity = '0.8';
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.borderColor = tokens.color.divider;
                      e.currentTarget.style.opacity = '1';
                    }}
                  >
                    <div style={{ fontSize: '13px', fontWeight: 600, color: tokens.color.text.primary, marginBottom: '4px' }}>
                      Explore Fields
                    </div>
                    <div style={{ fontSize: '12px', color: tokens.color.text.secondary }}>
                      Discover research fields and contribute nodes
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div style={{ fontSize: '12px', color: tokens.color.text.secondary }}>
                      Edit your username, email, password, or photo
                    </div>
                  </div>

                  <div
                    onClick={() => router.push('/orientate')}
                    style={{
                      padding: '12px',
                      background: tokens.color.bg.elevated,
                      border: `1px solid ${tokens.color.divider}`,
                  ...
                  >
                    ...
                    <div style={{ fontSize: '12px', color: tokens.color.text.secondary }}>
                      Learn how to use Field Nodes effectively
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div style={{ 
                  ...
                  <div style={{ fontSize: '12px', color: tokens.color.text.muted }}>
                    No activity yet. Start by exploring fields or creating your first node.
                  </div>
                </div>
              </div>
            </div>
